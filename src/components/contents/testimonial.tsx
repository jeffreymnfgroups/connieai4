            ...
            <AnimationContainer>
                <div className="flex flex-col items-center justify-center max-w-2xl mx-auto">
                    ...
                    <motion.p
                        ...
                        We are very proud of the meeting intelligence service we provide and stand by every feature we offer. Read our testimonials from teams that have transformed their meeting workflows.
                    </motion.p>
                </div>
            </AnimationContainer>
