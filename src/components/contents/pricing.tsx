            ...
            <div className="flex flex-col items-center justify-center max-w-2xl mx-auto">
                <AnimationContainer className="flex flex-col items-center justify-center">
                    ...
                    <p className="max-w-lg mt-6 text-center text-neutral-500">
                        Our pricing plans are designed to meet the needs of sales teams, onboarding specialists, and project managers. Start with our free trial and scale as you grow.
                    </p>
                </AnimationContainer>
    ...
    return (
        ...
        >
                    ...
                    <div key={index} className="flex items-center justify-start gap-2">
                        ...
                        >
                            <Zap
                                className={cn(
                                    "w-3 h-3",
                                    plan.title === "Professional" ? "text-primary fill-primary" : "text-neutral-600 fill-neutral-600"
                                )}
                            />
                        </div>
            ...
            <div className="flex flex-col items-start w-full px-4 pt-2 pb-5 md:pb-6 md:px-6">
                <Button size="lg" variant={plan.title === "Professional" ? "default" : "white"} className="w-full">
                    {plan.buttonText}
                </Button>
