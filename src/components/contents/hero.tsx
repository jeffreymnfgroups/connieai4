                ...
                <div className="flex flex-col items-center justify-center gap-y-4">
                    <AnimationContainer className="relative hidden lg:block overflow-hidden">
                        <Badge size="sm" variant="subtle" className="px-3 cursor-pointer">
                            <span className="px-2 py-[0.5px] h-[18px] tracking-wide flex items-center justify-center rounded-full bg-gradient-to-r from-pink-400 to-pink-600 text-[9px] font-medium mr-2 text-white">
                                NEW
                            </span>
                            <span>
                    ...
                    <AnimationContainer delay={0.2}>
                        <p className="max-w-xl mt-2 text-base text-center text-accent-foreground/60">
                            CoNNIE AI transforms every sales call, team meeting, and onboarding session into actionable insights and automated follow-ups. <span className="hidden lg:inline">Transform your meetings into clear, actionable insights—so you never miss a key moment again.</span>
                        </p>
